...
function changeSlider(index) {
    ...
    let dots = document.querySelectorAll(".circles .dots");
    let lastActiveDot = document.querySelector(".circles .circle_active");
    let links = document.querySelectorAll(".desktop a")
    let lastActiveLink = document.querySelector(".desktop a.active");
...
const dots = document.querySelectorAll(".circles .dots");
